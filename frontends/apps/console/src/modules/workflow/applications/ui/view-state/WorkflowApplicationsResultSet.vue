...
import WorkflowApplicationsCardCollectionView from "@/modules/workflow/applications/ui/result-set/card-collection-view/WorkflowApplicationsCardCollectionView.vue";

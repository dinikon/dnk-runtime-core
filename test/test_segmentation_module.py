...
class SegmentationModuleSmokeTests(unittest.TestCase):
    ...
    def test_dependency_placeholders_import_without_side_effects(self) -> None:
        ...
        self.assertIn("PreviewSegmentConfigUseCaseDep", application.__all__)
        self.assertIn("PreviewSegmentVersionUseCaseDep", application.__all__)
        self.assertIn("PreviewSegmentDefinitionUseCaseDep", application.__all__)
        self.assertIn("SegmentVersionRuleExecutorDep", application.__all__)
        self.assertIn("SegmentVersionInheritanceEvaluatorDep", application.__all__)
        self.assertIn("SegmentVersionEvaluationServiceDep", application.__all__)
        ...
        self.assertIn("ContactAudienceQueryDep", infrastructure.__all__)
        self.assertIn("StaticContactAudienceQueryDep", infrastructure.__all__)

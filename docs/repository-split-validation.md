...
> Исторический отчёт о разделении на версии 0.3.1. Актуальная структура двух корневых
> charts 0.3.2 и её проверки описаны в [Helm validation](../helm/VALIDATION.md).

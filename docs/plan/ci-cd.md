...
| `make publish-feature` | Публикация образов `feat-<SHA8>` и Helm chart с alias `feat` из чистой feature-ветки; [требования и повторы](../operations/ci-cd.md#образы-из-feature-ветки) |

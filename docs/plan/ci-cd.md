...
- Helm manifests are not present yet. They need to be added under `deploy/helm/dnk-runtime-core`.
...
```text
deploy/helm/dnk-runtime-core/Chart.yaml
deploy/helm/dnk-runtime-core/values.yaml
deploy/helm/dnk-runtime-core/values-test.yaml
deploy/helm/dnk-runtime-core/values-prod.yaml
deploy/helm/dnk-runtime-core/templates/deployment.yaml
deploy/helm/dnk-runtime-core/templates/service.yaml
deploy/helm/dnk-runtime-core/templates/ingress.yaml
deploy/helm/dnk-runtime-core/templates/configmap.yaml
```
...
```bash
helm lint deploy/helm/dnk-runtime-core
helm template dnk-runtime-core deploy/helm/dnk-runtime-core -f deploy/helm/dnk-runtime-core/values-test.yaml
helm template dnk-runtime-core deploy/helm/dnk-runtime-core -f deploy/helm/dnk-runtime-core/values-prod.yaml
```
...
```yaml
  helm:
    ...
    steps:
      ...
      - name: Helm lint
        run: helm lint deploy/helm/dnk-runtime-core

      - name: Render test manifests
        run: helm template dnk-runtime-core deploy/helm/dnk-runtime-core -f deploy/helm/dnk-runtime-core/values-test.yaml

      - name: Render prod manifests
        run: helm template dnk-runtime-core deploy/helm/dnk-runtime-core -f deploy/helm/dnk-runtime-core/values-prod.yaml
```

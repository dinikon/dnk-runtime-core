...
from src.config.infrastructure.communication_queue_config import CommunicationQueueConfig
...
ENV_FILE_PATH = search_file_upwards(
    base_dir_path=Path(__file__).parent,
    target_file_name=".env",
    max_search_parent_depth=3,
)
PYPROJECT_TOML_PATH = search_file_upwards(
    base_dir_path=Path(__file__).parent,
...
class DnkConfig(
    ...
    # **Before using, please contact business@dnk.net by email to inquire about licensing matters.**

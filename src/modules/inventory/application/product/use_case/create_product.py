...
class CreateProductUseCaseProtocol(Protocol):
    """Порт use case создания товара."""

    async def __call__(self, command: CreateProductCommand) -> ProductDTO:
        """Создает товар и возвращает DTO."""
        ...


class CreateProductUseCase:
    """Use case создания товара через доменный сервис."""
    ...
    async def __call__(self, command: CreateProductCommand) -> ProductDTO:
        """Выполняет команду создания товара и мапит entity в DTO."""

...
class RelationResponseSchema(BaseModel):
    """HTTP response schema для relation metadata."""
...
class ListRelationsResponseSchema(BaseModel):
    """HTTP response schema списка relations."""

    items: list[RelationResponseSchema]
    count: int


__all__ = ["ListRelationsResponseSchema", "RelationResponseSchema"]

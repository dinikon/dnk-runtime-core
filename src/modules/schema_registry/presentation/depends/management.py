...
def build_diff_schema_use_case(
    *,
    ...
    field_type_service = get_field_type_service()
    ...
    schema_seed_service = get_schema_seed_service(get_schema_seed_reader())
    postgres_schema_service = get_postgres_schema_service(
        inspector=get_tenant_schema_inspector(uow, field_type_service),
        executor=get_tenant_schema_executor(uow, field_type_service),
    )
    return get_diff_schema_use_case(
        ...
        schema_diff_service=get_schema_diff_service(field_type_service),

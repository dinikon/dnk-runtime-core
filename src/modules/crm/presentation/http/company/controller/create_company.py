...
from src.modules.crm.presentation.depends.application import CreateCompanyUseCaseDep
...
async def create_company(
    ...
    """HTTP endpoint создания компании текущего tenant."""
    ...
    command = CreateCompanyCommand(
        ...
        company_id=CompanyIdVO.from_value(uuid6.uuid7()),

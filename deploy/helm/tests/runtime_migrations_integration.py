...
Usage: python deploy/helm/tests/runtime_migrations_integration.py
...
RUNTIME_RELATIVE = Path("deploy/helm/dnk-platform/charts/dnk-runtime-core/files")
        ...
        try:
            ...
            process = subprocess.run(
                [
                    ...
                    "python",
                    image,
                    "/dnk-source/deploy/helm/tests/runtime_migrations_integration.py",
                    "--inside",
                ]
            )

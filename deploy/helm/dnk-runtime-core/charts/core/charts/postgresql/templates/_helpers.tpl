...
{{- else -}}
{{- printf "%s-%s" .Release.Name (default "core-postgresql" .Values.nameOverride) | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
...
app.kubernetes.io/name: {{ default "core-postgresql" .Values.nameOverride | quote }}
